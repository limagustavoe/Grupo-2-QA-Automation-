Cypress.Commands.add("contrasenaSinRequisitos", () => {
  ...
  cy.get('[data-cy="input-password"]').clear().type('carlosaltavista')
  cy.get('[data-cy="input-repetir-password"]').clear().type('carlosaltavista')
