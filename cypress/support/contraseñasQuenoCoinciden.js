Cypress.Commands.add("contrasenasDesiguales", () => {
  ...
  cy.get('[data-cy="input-confirmar-email"]').clear().type('albertocarlosalbertoa@gmail.com')
  cy.get('[data-cy="input-password"]').clear().type('Carlosaltavista990$')
